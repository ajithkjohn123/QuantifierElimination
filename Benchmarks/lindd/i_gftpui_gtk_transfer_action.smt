(benchmark i_gftpui_gtk_transfer_action
:extrafuns ((x0 Int))
:extrafuns ((x32 Int))
:extrafuns ((x33 Int))
:extrafuns ((x34 Int))
...
:formula
 ...
 (x9 Int)
  ...
  (and
    ...
    (or (and (<= (+ (* 1 x18) (* (~1) x0)) 0) (and (<= (+ (* 1 x22) (* (~1) x21)) 0) (not (<= (+ (* 1 x22) (* (~1) x21)) (~1))))) (and (and (not (<= (+ (* 1 x18) (* (~1) x0)) 0)) (<= (+ (* 1 x20) (* (~1) x0)) 0)) (and (<= (+ (* 1 x22) (* (~1) x19)) 0) (not (<= (+ (* 1 x22) (* (~1) x19)) (~1))))))
    (or (and (<= (+ (* 1 x26) (* (~1) x0)) 0) (and (<= (+ (* 1 x30) (* (~1) x29)) 0) (not (<= (+ (* 1 x30) (* (~1) x29)) (~1))))) (and (and (not (<= (+ (* 1 x26) (* (~1) x0)) 0)) (<= (+ (* 1 x28) (* (~1) x0)) 0)) (and (<= (+ (* 1 x30) (* (~1) x27)) 0) (not (<= (+ (* 1 x30) (* (~1) x27)) (~1))))))
    (or (and (<= (+ (* 1 x4) (* (~1) x0)) 0) (and (<= (+ (* 1 x8) (* (~1) x7)) 0) (not (<= (+ (* 1 x8) (* (~1) x7)) (~1))))) (and (and (not (<= (+ (* 1 x4) (* (~1) x0)) 0)) (<= (+ (* 1 x6) (* (~1) x0)) 0)) (and (<= (+ (* 1 x8) (* (~1) x5)) 0) (not (<= (+ (* 1 x8) (* (~1) x5)) (~1))))))
    (or (and (<= (+ (* 1 x34) (* (~1) x0)) 0) (and (<= (+ (* 1 x38) (* (~1) x37)) 0) (not (<= (+ (* 1 x38) (* (~1) x37)) (~1))))) (and (and (not (<= (+ (* 1 x34) (* (~1) x0)) 0)) (<= (+ (* 1 x36) (* (~1) x0)) 0)) (and (<= (+ (* 1 x38) (* (~1) x35)) 0) (not (<= (+ (* 1 x38) (* (~1) x35)) (~1))))))
    ...
    (or (and (and (<= (+ (* 1 x9) (* (~1) x0)) 3) (not (<= (+ (* 1 x9) (* (~1) x0)) 2))) (not (<= (+ (* 1 x10) (* (~1) x0)) 0))) (and (not (and (<= (+ (* 1 x9) (* (~1) x0)) 3) (not (<= (+ (* 1 x9) (* (~1) x0)) 2)))) (<= (+ (* 1 x10) (* (~1) x0)) 0)))
