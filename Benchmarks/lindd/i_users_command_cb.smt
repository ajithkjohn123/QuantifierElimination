...
:formula
 ...
 (x9 Int)
  ...
  (and
    ...
    (and (<= (+ (* 1 x30) (* (~1) x0)) 0) (and (<= (+ (* 1 x38) (* (~1) x29)) 0) (not (<= (+ (* 1 x38) (* (~1) x29)) (~1)))))
    ...
    (and (<= (+ (* 1 x49) (* (~1) x0)) 0) (and (<= (+ (* 1 x56) (* (~1) x55)) 0) (not (<= (+ (* 1 x56) (* (~1) x55)) (~1)))))
    ...
    (or (and (<= (+ (* 1 x58) (* (~1) x0)) 0) (and (<= (+ (* 1 x59) (* (~1) x57)) 0) (not (<= (+ (* 1 x59) (* (~1) x57)) (~1))))) (and (and (<= (+ (* 1 x58) (* (~1) x0)) 0) (<= (+ (* 1 x60) (* (~1) x0)) 0)) (and (<= (+ (* 1 x59) (* (~1) x61)) 0) (not (<= (+ (* 1 x59) (* (~1) x61)) (~1))))))
