(benchmark i_status_selection_changed
:extrafuns ((x0 Int))
:extrafuns ((x63 Int))
:extrafuns ((x64 Int))
:extrafuns ((x65 Int))
...
:formula
 ...
 (x9 Int)
  ...
  (and
    ...
    (and (<= (+ (* 1 x69) (* (~1) x0)) 0) (and (<= (+ (* 1 x77) (* (~1) x68)) 0) (not (<= (+ (* 1 x77) (* (~1) x68)) (~1)))))
    ...
    (or (and (and (<= (+ (* 1 x40) (* (~1) x23)) 0) (not (<= (+ (* 1 x40) (* (~1) x23)) (~1)))) (not (<= (+ (* 1 x41) (* (~1) x0)) 0))) (and (not (and (<= (+ (* 1 x40) (* (~1) x23)) 0) (not (<= (+ (* 1 x40) (* (~1) x23)) (~1))))) (<= (+ (* 1 x41) (* (~1) x0)) 0)))
