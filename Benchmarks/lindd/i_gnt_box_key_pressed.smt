(benchmark i_gnt_box_key_pressed
:extrafuns ((x0 Int))
:extrafuns ((x46 Int))
:extrafuns ((x47 Int))
:extrafuns ((x48 Int))
...
:formula
 ...
 (x9 Int)
  ...
  (and
    ...
    (and (not (<= (+ (* 1 x19) (* (~1) x0)) 0)) (and (<= (+ (* 1 x56) (* (~1) x0)) 0) (not (<= (+ (* 1 x56) (* (~1) x0)) (~ 1)))))
    ...
    (or (and (<= (+ (* 1 x34) (* (~1) x0)) 0) (and (<= (+ (* 1 x37) (* (~1) x33)) 0) (not (<= (+ (* 1 x37) (* (~1) x33)) (~1))))) (and (and (not (<= (+ (* 1 x34) (* (~1) x0)) 0)) (not (<= (+ (* 1 x36) (* (~1) x0)) 0))) (and (<= (+ (* 1 x37) (* (~1) x33)) 0) (not (<= (+ (* 1 x37) (* (~1) x33)) (~1))))))
