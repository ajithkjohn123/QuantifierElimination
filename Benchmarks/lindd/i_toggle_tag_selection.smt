(benchmark i_toggle_tag_selection
:extrafuns ((x0 Int))
:extrafuns ((x60 Int))
:extrafuns ((x61 Int))
:extrafuns ((x62 Int))
...
:formula
 ...
 (x9 Int)
  ...
  (and
    ...
    (and (<= (+ (* 1 x43) (* (~1) x0)) 0) (and (<= (+ (* 1 x51) (* (~1) x42)) 0) (not (<= (+ (* 1 x51) (* (~1) x42)) (~1)))))
    ...
    (or (and (<= (+ (* 1 x37) (* (~1) x0)) 0) (and (<= (+ (* 1 x39) (* (~1) x38)) 0) (not (<= (+ (* 1 x39) (* (~1) x38)) (~1))))) (and (not (<= (+ (* 1 x37) (* (~1) x0)) 0)) (and (<= (+ (* 1 x39) (* (~1) x0)) 0) (not (<= (+ (* 1 x39) (* (~1) x0)) (~ 1))))))
    ...
    (or (and (<= (+ (* 1 x71) (* (~1) x0)) 0) (and (<= (+ (* 1 x73) (* (~1) x70)) 0) (not (<= (+ (* 1 x73) (* (~1) x70)) (~1))))) (and (not (<= (+ (* 1 x71) (* (~1) x0)) 0)) (and (<= (+ (* 1 x73) (* (~1) x72)) 0) (not (<= (+ (* 1 x73) (* (~1) x72)) (~1))))))
    ...
    (or (and (and (<= (+ (* 1 x68) (* (~1) x0)) 1) (not (<= (+ (* 1 x68) (* (~1) x0)) 0))) (not (<= (+ (* 1 x69) (* (~1) x0)) 0))) (and (not (and (<= (+ (* 1 x68) (* (~1) x0)) 1) (not (<= (+ (* 1 x68) (* (~1) x0)) 0)))) (<= (+ (* 1 x69) (* (~1) x0)) 0)))
